    ...
    <section className="py-12 bg-white">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          {/* BIC Code Section */}
          <div>
            <h2 className="text-2xl md:text-3xl font-bold mb-6">Understanding BIC Codes</h2>
            ...
            <div className="bg-gray-50 p-6 rounded-lg mb-6">
              <h3 className="font-bold text-lg mb-3">BIC Code Format</h3>
              ...
              <div className="flex items-center justify-center bg-white p-4 rounded-lg mb-4 shadow-sm">
                <div className="text-center px-3 py-2 bg-blue-600 text-white rounded-l-md">
                  <span className="block text-xs">Owner Code</span>
                  <span className="font-mono font-bold">ABCU</span>
                </div>
                <div className="text-center px-3 py-2 bg-green-600 text-white">
                  <span className="block text-xs">Number</span>
                  <span className="font-mono font-bold">123456</span>
                </div>
                <div className="text-center px-3 py-2 bg-orange-500 text-white rounded-r-md">
          ...
          <div>
            <h2 className="text-2xl md:text-3xl font-bold mb-6">Understanding Container Capacity</h2>
              ...
              <table className="w-full text-left border-collapse mb-6">
                <thead>
                  <tr className="bg-blue-600 text-white">
                    ...
                    <th className="p-3 font-semibold">Internal Volume</th>
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              <h3 className="font-bold text-lg mb-3">Choosing the Right Size</h3>
              ...
              <ul className="list-disc pl-5 space-y-1">
                ...
                <li>Future expansion or modification plans</li>
              </ul>
            </div>
          </div>
        </div>

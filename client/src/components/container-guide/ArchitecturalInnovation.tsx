import modernOfficeImage from '@assets/Modern-Office.png';
import emergencyResponseImage from '@assets/Emergency Response Units.png';
import containerHomeImage from '@assets/home.png';
import businessImage from '@assets/Business.png';
import garageImage from '@assets/garage_shed.png';

export default function ArchitecturalInnovation() {
  return (
    <section className="py-12 bg-gray-50">
      <div className="container mx-auto px-4">
        <h2 className="text-2xl md:text-4xl font-bold text-center mb-4">Architectural Innovation</h2>
        <p className="text-center text-gray-600 max-w-3xl mx-auto mb-12">Experience the future of sustainable architecture with our container conversion possibilities. From basic modifications to complete transformations.</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white rounded-lg overflow-hidden shadow-lg">
            ...
            />
            <div className="p-6">
              <h3 className="text-xl font-bold mb-3">Emergency Response Units</h3>
          ...
          <div className="bg-white rounded-lg overflow-hidden shadow-lg">
            ...
            />
            <div className="p-6">
              <h3 className="text-xl font-bold mb-3">Modern Office Complexes</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
          <div className="bg-white rounded-lg overflow-hidden shadow-md flex flex-col">
            <div className="p-0">
              <img 
                src={containerHomeImage} 
                alt="Modern container home with glass walls" 
                className="w-full h-40 object-cover rounded-t-lg" 
              />
            </div>
            <div className="p-4 flex-grow">
              <h3 className="font-bold text-lg mb-2">Eco-friendly Housing</h3>
          ...
          <div className="bg-white rounded-lg overflow-hidden shadow-md flex flex-col">
            ...
            <div className="p-4 flex-grow">
              <h3 className="font-bold text-lg mb-2">Remote Work Stations</h3>
          ...
          <div className="bg-white rounded-lg overflow-hidden shadow-md flex flex-col">
            ...
            <div className="p-4 flex-grow">
              <h3 className="font-bold text-lg mb-2">Garage & Shed Solutions</h3>

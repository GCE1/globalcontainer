  ...
  return (
    <section className="py-12 bg-blue-600 text-white">
      <div className="container mx-auto px-4">
        <h2 className="text-2xl md:text-4xl font-bold text-center mb-8">The Evolution of Shipping Containers</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white bg-opacity-10 p-6 rounded-lg">
            <h3 className="font-bold text-xl mb-3">The Beginning</h3>
          ...
          <div className="bg-white bg-opacity-10 p-6 rounded-lg">
            <h3 className="font-bold text-xl mb-3">Standardization</h3>
